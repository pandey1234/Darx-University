...
if ($_REQUEST['submitForm'] == 'yes') {
  ...
  if ($_REQUEST['id'] == '') {
    $obj->query("insert into $tbl_leader set title='$title',description='$description',photo='$fileNameNew'", -1); //die;
    $_SESSION['sess_msg'] = 'leader added sucessfully';
  } else {
    $obj->query("update $tbl_leader set title='$title',description='" . $description . "',photo='" . $fileNameNew . "',status=1 where id=" . $_REQUEST['id'], $debug = -1); //die;
    $_SESSION['sess_msg'] = 'leader updated successfully';
  }
  header("location:leader-list.php");
  exit();
}


if ($_REQUEST['id'] != '') {
  $sql = $obj->query("select * from $tbl_leader where id=" . $_REQUEST['id']);
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><?php if ($_REQUEST['id'] != '') { ?>Update <?php } else { ?> Add <?php } ?> leader</h1>
        <ol class="breadcrumb">
          <li><a href="javascript:void(0);"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="leader-list.php">View leader List</a></li>
        </ol>
      </section>
          ...
          <form name="frm" id="frm" method="POST" enctype="multipart/form-data" action="" onSubmit="return validate(this)">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>leader Image (500px X 500px)</label>
