...
<script src="js/jquery-2.2.3.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
           <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage Portfolio</h4></div>
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add admin"  class="button" onclick="location.href='portfolio-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
		<form name="frm" method="post" action="portfolio-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
				$i=1;
				$sql=$obj->query("select * from $tbl_portfolio where 1=1 and user_type='admin' $whr order by id desc",$debug=-1);
                ...
                <tr>
                  ...
                  <label for="squaredFour<?php echo $line->id;?>"></label>
					...
					<td><?php echo stripslashes($line->solution)." ".stripslashes($line->emp_surname);?></td>
					<td><?php if(is_file("../upload_images/banner/".$line->image)){?>
                        <img src="../upload_images/banner/<?php echo  $line->image;?>" width="100px"/>
                        <?php } ?>
            </td>
          ...
          <?php }?></td>
          <td>
            <a href="portfolio-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="Edit admin"> <i class="fa fa-pencil"></i></a>
