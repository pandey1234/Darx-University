  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add services"  class="button btn-success" onClick="location.href='services-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
          ...
          <div class="box">
            <div class="box-body">
              <table id="banner-list" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from $tbl_services where 1=1",$debug=-1);
                ...
                <tr>
					...
					<td align="center">
					<label class="switch">
		              <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_services?>">
		              <div class="slider round"></div>
		            </label>

			          </td>
			          <td><a href="services-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
			          </td>
