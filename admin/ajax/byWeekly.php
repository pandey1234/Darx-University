...
validate_admin();
      ...
      $sql=$obj->query("SELECT * from tbl_tmp_cart where cart_type='2' ");
...
?>
      ...
      <div class="col-md-12">
      <h3 style="margin-top:15px;">Weekly Basket Products</h3>
                      ...
                      <tbody>
                        ...
                        <?php
                         ...
                         <?php } }
                          ...
                          <div class="error" style="margin:20px;">No item in your weekly basket</div>
                          <?php }?>
                      </tbody>
                      </table>
                        <div class="clr"></div>
