...
validate_admin();
      ...
      $sql=$obj->query("SELECT * from tbl_tmp_cart where cart_type='1' ");
...
?>    <div class="clr"></div>
       <div class="col-md-12">
       <h3 style="margin-top:15px;">Daily Basket Products</h3>
                      ...
                      <tbody>
                        ...
                        <?php
                         ...
                         <?php } }
                          ...
                          <div class="error" style="margin:20px;">No item in your daily basket</div>
                          <?php }?>
                      </tbody>
                      <tfoot>
                        </tfoot>
