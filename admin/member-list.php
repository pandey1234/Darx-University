 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage Member</h4></div>
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add member"  class="button btn-success" onClick="location.href='member-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
          ...
          <div class="box">
            <div class="box-body">
              <table id="member-list" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from $tbl_member where 1=1",$debug=-1);
                ...
                <tr>
					...
					<td><?php echo ucfirst(stripslashes($line->occupation)); ?></td>
					<td><?php if(is_file("../upload_images/banner/".$line->photo)){?>
                                <img src="../upload_images/banner/<?php echo  $line->photo;?>" width="100px"/>
                                <?php } ?>
                    </td>
					<!-- <td><?php echo stripslashes($line->target_url); ?></td> -->
					<td align="center">
					<label class="switch">
		              <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_member?>">
		              <div class="slider round"></div>
		            </label>

			          </td>
			          <td><a href="member-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
			          </td>
