 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage FAQ Banner</h4></div>
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add FAQ Banner"  class="button btn-success" onClick="location.href='faq-banner-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
		<form name="frm" method="post" action="faq-banner-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
              <table id="faq-banner-list" class="table table-bordered table-striped">
                <thead>
                <tr>
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from $tbl_faq_banner where 1=1",$debug=-1);
                ...
                <tr>
					...
					<td><?php if(is_file("../upload_images/faq-banner/".$line->photo)){?>
                                <img src="../upload_images/faq-banner/<?php echo  $line->photo;?>" width="100px"/>
                                <?php } ?>
                    </td>
					...
					<label class="switch">
			          ...
			          <td><a href="faq-banner-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
			          </td>
	...
	function del_prompt(frmobj,comb)
		...
		//alert(comb);
			if(comb=='Delete'){
				...
				{
					frmobj.action = "faq-banner-del.php";
