 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage TnC</h4></div>
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add TnC"  class="button btn-success" onClick="location.href='tnc-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
		<form name="frm" method="post" action="tnc-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
              <table id="banner-list" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from $tbl_tnc where 1=1",$debug=-1);
                ...
                <tr>
					...
					<td><?php echo ucfirst(stripslashes($line->tnc)); ?></td>
					<td><?php echo ucfirst(stripslashes($line->decs)); ?></td>
					

					<td align="center">
					<label class="switch">
		              <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_tnc?>">
		              <div class="slider round"></div>
		            </label>

			          </td>
			          <td><a href="tnc-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
			          </td>
